...
public class QueryTest {
    ...
    private void getTravelReviewUniqueRecord() {
        ...
        Query query = session.createQuery("from TravelReview where id=21");
    ...
    private void getTravelReviewWithSelect() {
        String SELECT_QUERY = "SELECT TravelReview.id from TravelReview";
        ...
        List<Integer> reviews = query.list();
    ...
    private void deleteTravelReview() {
        ...
        Query query = session.createQuery("delete TravelReview where id=24");
        int success = query.executeUpdate();
    ...
    public static void main(String[] args) {
        ...
        // test.getTravelReviewWithQueryParam(JOptionPane.showInputDialog("Enter city"));
